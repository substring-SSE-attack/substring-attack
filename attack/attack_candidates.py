...
def refine_candidates_token(candidates_token, candidates_token_score, N_filter=3):
...
def find_token_candidates(char_equality_group, leakage_tree, leakage_level, string_freq, id_to_leakage_tokens_map, auxiliary_freq, char_set, sigma=6, N_filter=3):
    candidates_token = {}
    ...
    candidates_token_seq = fill_candidates(candidates_token_seq, string_freq, auxiliary_freq, auxiliary_freq_lookup, sigma=sigma)
