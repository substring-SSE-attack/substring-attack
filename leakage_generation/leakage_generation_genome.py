...
if __name__ == "__main__":
    ...
    if args.g1 == False:
        for target_idx in range(args.ncopy):
            ...
            file_input = open(f'../suffix_trees/suffix_tree_genome_1_0', 'rb')
            ...
            file_output = open(f'../leakage_output/genome/leakage_1_{args.nqry}_{target_idx}.pkl', 'wb')
            pickle.dump(leakage_dict, file_output)
            file_output.close()

            file_output = open(f'../leakage_output/genome/edge_map_1_{args.nqry}_{target_idx}.pkl', 'wb')
